    ...
    (async () => {
      ...
      if (Results) {
        Results.forEach((make) =>
          currentMakeOptions.push(
            <MenuItem value={`${make.Model_Name}`}>{make.Model_Name}</MenuItem>
          )
        );
              ...
              <div style={{ display: "flex", flexDirection: "row" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  <Input
                    type="number"
                    value={lease_cash}
                    onChange={(e) => setLeaseCash(e.target.value)}
                  />
                </div>
              </div>
              ...
              >
                <div style={{ width: "100px" }}>
                  <Checkbox
                    ...
                    value={listed}
                    checked={listed === true}
                    onClick={(e) => setListed(!listed)}
                  />
                  <Checkbox
                    style={{ width: "0px", height: "0px" }}
                    label="Advertise"
                    value={advertise}
                    checked={advertise === true}
                  ...
                  <Checkbox
                    ...
                    value={demo}
                    checked={demo === true}
                    onClick={(e) => setDemo(!demo)}
                  />
                </div>
                <DateInput
                  placeholder="MM/YYYY active"
                  value={listed_date}
                  onChange={(e) => setActiveMonth(e.value)}
                />{" "}
                <p>Active month</p>
              </div>
            </div>
